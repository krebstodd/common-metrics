...
public class MqResourceCallEventData extends BaseResourceCallEventData<MqResource, MqAction> {
    ...
    public MqResourceCallEventData(final Direction direction, final Long durationMillis, final MqResource resource, final MqAction action, final Status status, final TrackingInfo trackingInfo) {
