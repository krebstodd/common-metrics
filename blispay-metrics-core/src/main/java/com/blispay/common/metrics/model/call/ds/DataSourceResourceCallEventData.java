...
public class DataSourceResourceCallEventData extends BaseResourceCallEventData<DsResource, DsAction> {
    ...
    public DataSourceResourceCallEventData(final Direction direction, final Long durationMillis, final DsResource resource, final DsAction action, final Status status, final UserTrackingInfo trackingInfo) {
